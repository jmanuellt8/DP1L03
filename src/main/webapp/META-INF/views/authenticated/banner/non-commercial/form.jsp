...
<acme:form>
    ...
    <acme:form-submit test="${command == 'show'}"
                      code="authenticated.banner.non-commercial.form.button.update"
                      action="/authenticated/non-commercial-banner/update"/>

    <acme:form-submit test="${command == 'show'}"
                      code="authenticated.banner.non-commercial.form.button.delete"
                      action="/authenticated/non-commercial-banner/delete"/>

    <acme:form-submit test="${command == 'create'}"
                      code="authenticated.banner.non-commercial.form.button.create"
                      action="/authenticated/non-commercial-banner/create"/>
